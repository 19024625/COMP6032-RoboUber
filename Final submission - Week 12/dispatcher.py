...
class Dispatcher:
      ...
      def recvPayment(self, parent, amount):
          ...
          print("Taxi revenue: ", self._revenue)
      ...
      def _costFare(self, fare):
          ...
          #This print is used for testing purposes.
          print("!!!!!!!!!timeToDestination: " + timeToDestination)
          ...
          # Time to destination equalling to 50 represents going from one side of the map to the other.
          # Most of the time, this would not be efficient, so a large fare cost has been chosen for this.
